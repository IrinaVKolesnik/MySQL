...
/*****4d. Perhaps we were too hasty in changing GROUCHO to HARPO. It turns out that GROUCHO was the correct name after all! In a single query, 
    ...
    ***Write a single SQL Query to change all entries in the column that match "HARPO" to "GROUCHO" 
...
UPDATE actor 
    ...
    WHEN first_name='HARPO' THEN 'GROUCHO' END 
...
GROUP BY f.title;  /*answer: 6 copies*/
